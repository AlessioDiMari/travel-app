        ...
        <div id="days-container" class="p-3">
            ...
            <div class="form-group" id="day-0">
                ...
                <div id="stops-container-0" class="p-5">
                    <h4>Tappe</h4>
                    <div class="form-group" id="stop-0-0">
                        ...
                        <button type="button" class="btn btn-danger remove-stop" data-stop-id="stop-0-0">Elimina Tappa</button>
                    </div>
                </div>
                <button type="button" class="btn btn-secondary add-stop" data-day-index="0">Aggiungi Tappa</button>
                <button type="button" class="btn btn-danger remove-day" data-day-id="day-0">Elimina Giornata</button>
            </div>
        </div>
